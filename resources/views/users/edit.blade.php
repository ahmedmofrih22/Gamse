                ...
                <form action="{{ route('users.update', $user->id) }}" method="post" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="">
                        ...
                        <div class="row mg-b-20">
                            ...
                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                ...
                                <input class="form-control form-control-sm mg-b-20" data-parsley-class-handler="#lnWrapper" name="email" required="" type="text" value="{{ $user->email }}">
                            </div>
                        </div>
                    ...
                    <div class="row mg-b-20">
                        ...
                        <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                            ...
                            <img style="width: 90px; height: 90px;" src="{{asset('images/user/'.$user->photo)}}"></td>
                        </div>
                    </div>
                    <div class="mg-t-30">
